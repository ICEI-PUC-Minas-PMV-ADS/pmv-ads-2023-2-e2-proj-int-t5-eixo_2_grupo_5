...
| Usuário | Artefato | Tempo gasto | Clicks | Qtd. erros | Recuperação dos erros | Observações |
|---|---|---|---|---|---|---|
...
Com base no teste realizado com os artefatos CTU - 01, 02, 03, 07 e 08, identificou-se que tanto a funcionalidade do artefato 02 quanto a do 03 requerem melhorias.

Estes problemas serão abordados e corrigidos na próxima etapa do processo.

<h2>Relatório</h2>

**Teste de Usabilidade da aplicação Tech Talent: estudo de caso**

Os resultados do teste de usabilidade da aplicação Tech Talent foram analisados para avaliar o desempenho da ferramenta. Utilizamos o método de observação, registrando métricas como tempo, cliques, erros e observações. Com base nos dados coletados, identificamos padrões de comportamento, problemas em potencial e possíveis soluções.

O teste foi dividido em duas etapas: inicialmente, três usuários avaliaram os casos de teste 01, 03 e 07. Na segunda etapa, os outros três usuários testaram a aplicação em sua totalidade.
...
**Sugestão**: Colocar um fade-out mais duradouro até o desaparecimento da mensagem por completo.
...
Os testes de usabilidade são fundamentais para manter a aplicação dinâmica e interativa, garantindo que ela atenda às demandas dos usuários e progrida com base nos insights obtidos.
